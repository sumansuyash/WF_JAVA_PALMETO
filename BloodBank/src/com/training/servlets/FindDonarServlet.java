...
public class FindDonarServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<String> donarName= Arrays.asList("Ramesh","Suresh","Kamesh");
		
		if(reqGroup.equals("opos")) {
			donarName= Arrays.asList("michal","steve","john");
		}

		request.setAttribute("donar", donarName);
		RequestDispatcher dispatcher=request.getRequestDispatcher("/showDonar.jsp");
